...
// 2. The Abstracts Database (Keys 100% synchronized with index routing)
const abstractsDatabase: Record<string, AbstractData> = {
  
    // --- I. BIOLOGICAL SOVEREIGNTY ---
    ...
    // --- III. DIGITAL & HARDWARE SOVEREIGNTY ---
    "digital-firewall": {
    ...
    // --- IV. THE MAHA PRINCIPLE & DOCTRINE ---
    "architecting-renewal": {
