    ...
    >
      ...
      <section className="space-y-4">
        ...
        <div className="pl-4 border-l-2 border-transparent space-y-6">
          <p className="font-serif text-lg leading-relaxed text-gray-400">
            The doctrine began before the companies did. As a teenager in the early 2010s, I was sketching challenger-brand architecture for the mobile hardware sector — community-first launch models, zero-compromise spec doctrine, brand identity built on refusing hardware complacency — in the most fragile venue imaginable: YouTube descriptions, under a throwaway handle.
          </p>
          <p className="font-serif text-lg leading-relaxed text-gray-400">
