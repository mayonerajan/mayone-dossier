...
export default function AboutPage() {
  // STEP 3: Invisible Schema Block for AI/Crawlers
  const personSchema = {
    "@context": "https://schema.org",
    "@type": "Person",
    "name": "Mayone Maha Rajan",
    "jobTitle": "Managing Director",
    "description": "Architect of Biological Sovereignty. Synthesizing cognitive science, cybernetics, and decentralized technology.",
    "worksFor": {
      "@type": "Organization",
  ...
  return (
    <div className="max-w-2xl w-full mx-auto space-y-16 selection:bg-gray-700 pb-12 pt-12">
      ...
      {/* STEP 1: VISIBLE H1 WITH FULL NAME */}
        ...
        <div className="space-y-8 font-sans">
          ...
          <div className="group">
            ...
            <p className="text-sm text-gray-400 font-serif mt-2 pl-3.5 border-l border-gray-800 group-hover:border-indigo-500 transition-colors">
              Trained at the <a href="https://ucsd.edu" target="_blank" rel="noopener noreferrer" className="text-gray-300 border-b border-gray-700 hover:border-indigo-400 hover:text-indigo-400 transition-colors">University of California, San Diego (UCSD)</a>, my foundational studies in Cognitive Science focused on the precise neurological and psychological vulnerabilities of the human operating system. This research exposed how engagement-driven machine learning models induce algorithmic capture, laying the groundwork for defensive, user-centric frameworks.
            </p>
          </div>
          ...
          <div className="group">
            ...
            <p className="text-sm text-gray-400 font-serif mt-2 pl-3.5 border-l border-gray-800 group-hover:border-indigo-500 transition-colors">
              Before deploying digital defense systems, the constraints of thermodynamic efficiency were stress-tested in the physical world. Through percussive architecture and extended-range geometric experimentation with 8-string instruments—collaborating with boundary-pushing projects like <a href="https://www.tragicherorecords.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 border-b border-gray-700 hover:border-indigo-400 hover:text-indigo-400 transition-colors">Earthists (Tragic Hero Records)</a> and Red Seas Fire—I used polyrhythmic complexity to explore the biological limits of human motor precision and rhythmic focus.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-900/30 p-6 rounded-lg border border-gray-800 space-y-4">
        ...
        <p className="font-serif text-sm text-gray-400 leading-relaxed">
          Today, these independent tracks are unified under <a href="https://mahastrategies.com" target="_blank" rel="noopener noreferrer" className="text-gray-200 font-bold border-b border-gray-700 hover:border-indigo-400 hover:text-indigo-400 transition-colors">Maha Strategies LLC</a>, where I serve as Managing Director. We convert theoretical sovereignty frameworks into physical reality: engineering on-device AI, publishing formal systemic research papers, and deploying local-first infrastructure designed to insulate individuals and enterprises from systemic digital capture.
        </p>
        <div className="pt-2">
          <a 
            href="https://mahastrategies.com" 
            target="_blank" 
